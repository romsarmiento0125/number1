$(document).ready(function () {
    ...
    // ================== Events ==================
    $('#item_remove_discount').off('click');
    $('#item_remove_discount').on('click', function () {
        remove_discount_input();
    });

    $('#item_add_discount').off('click');
    $('#item_add_discount').on('click', function () {
        add_discount_input();
    });

    $('#add_product_item').off('click');
    $('#add_product_item').on('click', function () {
        add_item_details();
    });
