...
class DeliveryReceiptModel extends Model
{
    ...
    public function update_delivery_receipt($data)
    {
        try {
            $this->db->transStart(); // Start Transaction
    ...
    public function update_delivery_receipt_items($params)
    {
        try {
            $this->db->transStart(); // Start Transaction
    ...
    public function update_delivery_receipt_items_discounts($discounts, $dr_item_id, $user_id)
    {
        try {
            $this->db->transStart(); // Start Transaction

            // First, delete existing discounts for the item
            $deleteQuery = "DELETE FROM delivery_receipt_items_list_discount WHERE dr_item_id = ?";
            $this->db->query($deleteQuery, $dr_item_id);

            // Then, insert the  new discounts
            $insertQuery = "INSERT INTO delivery_receipt_items_list_discount (
                dr_item_id,
                discount_label,
                discount,
                creator_id,
    ...
    public function archive_delivery_receipt_items($params)
    {
        try {
            $this->db->transStart(); // Start Transaction
    ...
    public function print_delivery_receipt($params)
    {
        try {
            $this->db->transStart(); // Start Transaction
